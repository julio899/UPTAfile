...
<div  id="contenedor_docente" class="row">
	<div class="span3">
		...
		<ul class="nav nav-list bs-docs-sidenav affix-top">
          <li class="active"><a href="<?php echo base_url().index_page().'/docente/actualizar';?>"><i class="icon-info-sign"></i> Actualizar Mi Informaci&oacute;n</a></li>
          <li class=""><a href="<?php echo base_url().index_page().'/docente/modificar';?>"><i class="icon-exclamation-sign"></i> Modificar Contenidos</a></li>
	...
	<div class="span9">
		<!-- Inicio delformulario para actualizar -->
			...
			<div id="pantalla_docente">
				...
				<form class="form-inline" action="<?php echo base_url().index_page().'/docente/procesar_actualizacion_datos_docente';?>" method="post">
